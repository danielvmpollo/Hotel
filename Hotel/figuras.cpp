...
void CFiguras::laptopP (float altura, float largo, float profundidad, GLuint text1,GLuint text2)  //Funcion creacion prisma
{
...
void CFiguras::laptopT (float altura, float largo, float profundidad, GLuint text1,GLuint text2)  //Funcion creacion prisma
{
...
void CFiguras::cesped (float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
